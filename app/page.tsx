        ...
        <div className="psi-cta-inner">
          ...
          <form className="psi-form" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="psi-field">
              ...
              <textarea id="message" placeholder="Tell us about the property, any specific shots needed, or your timeline..." />
            </div>
            <button type="submit" className="psi-btn-submit">
              Send Request
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
      ...
      <footer>
        <div className="psi-footer-inner">
          <div className="psi-footer-copy">
            © 2025 <span>Phantom Sky Imaging</span>. All rights reserved.
          </div>
